...
const supportedCurrencies_js_1 = __importDefault(require("./supportedCurrencies.cjs"));
const convert = (from, to, amount) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!supportedCurrencies_js_1.default.includes(from))
        throw new Error(`Currency ${from} is not supported.`);
    if (!supportedCurrencies_js_1.default.includes(to))
